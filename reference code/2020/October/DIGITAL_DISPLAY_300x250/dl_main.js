...
var imageArray = new Array('dl_loading.gif','dl_replyicon.png', "f1-bg.jpg",  "end-frame.jpg", "f1-h1.png",  "f1-h2.png",  "f1-h3.png",);
...
function toggleIsi(e) {
  ...
  var toggleButton = document.querySelector('.js-toggle-isi');

  if (bannerContent.classList.contains('isi-expanded')) {
    bannerContent.classList.remove('isi-expanded');
    toggleButton.innerText = 'SEE MORE';
    _tt.play();

  } else {
    bannerContent.classList.add('isi-expanded');
...
.set(['.frame1__headline', '.frame1__headline2'], {opacity:0, y:-10})
// .set(['#img1','#cta'], {opacity:0, x:-300})
// .set(['#pill'], {opacity:0})

.to(['.frame1__headline'], 1, {y:0, opacity: 1, ease:Power1.easeInOut},'+=0')
.to(['.frame1__headline2'], 1, {y:0, opacity: 1, ease:Power1.easeInOut},'+=1')
.to(['.frame1__headline', '.frame1__headline2'],  .5, {opacity: 0, ease: Sine.easeOut }, '+=2')
.to(['.frame1__headline3'], .5, {opacity: 1, ease:Power1.easeInOut},'+=0')
.to(['.frame1__headline3'], .5, {opacity: 0, ease:Power1.easeInOut},'+=2')
.to(['.frame1__headline4'], .5, {opacity: 1, ease:Power1.easeInOut},'+=0')
.to(['.frame1'], .5, {opacity: 0, ease:Power1.easeInOut},'+=1.5')
...
.to('.frame1',1,{onComplete:function(){
...
window.onload = function() {
 ...
 ssb.scrollbar("main_content", false, 2000, 300, 60,false,2,9);
