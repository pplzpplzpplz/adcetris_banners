...
var imageArray = new Array('dl_loading.gif','dl_replyicon.png',  "img2.png","img3.png","img4.png");
...
.set(['#text2', '#text3','#text1'], {opacity:0, y:-10})
//.to('#text2',1,{y:0, opacity:1, ease:Power1.easeInOut},1)
//.to('#text3',1,{y:0, opacity:1, ease:Power1.easeInOut},1.5)

//.to(['#text1', '#text2', '#text3'], 1, {opacity:0, ease:Power1.easeInOut},5)

.set("#img2",{opacity:1, ease:Power1.easeInOut}, 0)

.from('#pill',0.6,{y:'-=80',ease:Power1.easeIn},0)
.from('#img2',1,{opacity:0},0.5)

.from("#img3", 1, {opacity:0, ease:Power1.easeInOut}, 2)
.to("#areaLogo", 0, {zIndex:151, ease:Power1.easeInOut}, 2)
.from("#img4", 1, {opacity:0, ease:Power1.easeInOut},2)


.from("#cta", 1, {opacity:1, y:90, ease:Power1.easeInOut, onComplete:function(){
...
window.onload = function() {
 ...
 ssb.scrollbar("main_content", false, 2000, 243, 90,false,5,-4);
