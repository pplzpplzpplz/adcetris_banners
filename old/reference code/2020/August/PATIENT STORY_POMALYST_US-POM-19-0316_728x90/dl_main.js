...
var imageArray = new Array('dl_loading.gif','dl_replyicon.png', "img1.png",  "cta.png", "pill.png", "text1.png",  "text2.png", "text3.png",  "text4.png","f1text1.png",  "f1text2.png", "f1text3.png",  "f1text4.png", "f1text5.png", "background.jpg", "imagen.jpg");
...
function initAnimations(){
    ...
    initHandlers()
	_tt
.set(['#f1text1','#f1text2', '#f1text3', '#f1text4', '#f1text5'], {opacity:0, y:-10, x:-2})
.set(['#text1','#text2', '#text3', '#text4'], {opacity:0, y:-10, x:-2})
.set(['#img1'], {opacity:0, x:-50})
.set(['#pill'], {opacity:0})
.set(['#imagen'], {x:-20,opacity:1, scale:0.9,y:10})
//.set(['#footer'], {opacity:0})


.staggerTo(['#f1text1','#f1text2', '#f1text3', '#f1text4', '#f1text5'],0.5,{y:0, opacity:1, ease:Power1.easeInOut},0.3, 0)
//.from(['#imagen'],1.5,{x:-70, opacity:0, ease:Power1.easeInOut}, 0)
.to(['#imagen'],13,{x:70, scale:1.1,y:0}, 0)

.to(['#f1text1','#f1text2', '#f1text3', '#f1text4', '#f1text5', '#imagen'],0.5,{ opacity:0, ease:Power1.easeInOut}, 4)
.from('#imagen2',0.5,{ opacity:0, ease:Power1.easeInOut}, 3.9)
.staggerTo(['#text1','#text2'],0.5,{y:0, opacity:1, ease:Power1.easeInOut},0.3, 4.5)
.staggerTo(['#text3', '#text4'],0.5,{y:0, opacity:1, ease:Power1.easeInOut},0.3, 6)

.to(['#img1'],1,{x:0, opacity:1, ease:Power1.easeInOut}, 6)
.to("#areaLogo", 0, {zIndex:151, ease:Power1.easeInOut}, 6)

.to(['#pill'],1,{opacity:1, ease:Power1.easeInOut},7)
.from(['#cta'],1,{x:-160, opacity:0, ease:Power1.easeInOut},7)
.from(['#footer'],1,{opacity:0, ease:Power1.easeInOut},6)
.to(['#scroll_container'],1,{bottom:14, opacity:1, ease:Power1.easeInOut},6)
...
window.onload = function() {
 ...
 ssb.scrollbar("main_content", false, 2000, 245, 80,false,4,-8);
