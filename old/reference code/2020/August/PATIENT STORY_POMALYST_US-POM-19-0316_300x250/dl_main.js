...
.set(['#img1'], {opacity:0, x:-300})
.set(['#pill'], {opacity:0})
.set(['#imagen'], {x:-30,opacity:1,scale:0.9,y:15})
...
.to(['#imagen'],13,{x:60,y:0,scale:1.06}, 0)
...
.to(['#img1'],1,{x:0, opacity:1, ease:Power1.easeInOut}, 6.5)
.to("#areaLogo", 0, {zIndex:151, ease:Power1.easeInOut}, 6.5)

.to(['#pill'],1,{opacity:1, ease:Power1.easeInOut},7.5)
.to(['#cta'],1,{x:190, opacity:1, ease:Power1.easeInOut},7.5)
.from(['#footer'],1,{opacity:0, ease:Power1.easeInOut},6.5)
.to(['#scroll_container'],1,{bottom:14, opacity:1, ease:Power1.easeInOut},6.5)
