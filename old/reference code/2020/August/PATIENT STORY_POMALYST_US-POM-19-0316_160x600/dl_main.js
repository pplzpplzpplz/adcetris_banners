...
.set(['#img1'], {opacity:0, x:-160})
.set(['#pill'], {opacity:0})
.set(['#imagen'], {x:-50,opacity:1,scale:0.9,y:20})
//.set(['#footer'], {opacity:0})


.staggerTo(['#f1text1','#f1text2', '#f1text3', '#f1text4', '#f1text5'],0.5,{y:0, opacity:1, ease:Power1.easeInOut},0.3, 0)
//.from(['#imagen'],2,{x:-70, opacity:0}, 0)
.to(['#imagen'],13,{x:60,y:-20,scale:1.2}, 0)
...
.to("#areaLogo", 0, {zIndex:151, ease:Power1.easeInOut}, 3.9)
...
.to(['#scroll_container'],1,{bottom:45, opacity:1, ease:Power1.easeInOut},6)
...
window.onload = function() {
 ...
 ssb.scrollbar("main_content", false, 2000, 160, 130,false,1.3,9);
